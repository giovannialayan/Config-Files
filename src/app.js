...
const app = express();
app.use('/assets', express.static(path.resolve(`${__dirname}../../${config.staticAssets.path}`)));
app.use(compression());
...
app.use(favicon(path.resolve(`${__dirname}/../${config.staticAssets}img/favicon.png`)));
